                                ...
                                <ul className="nav navbar-nav menu_nav ml-auto">
                                    ...
                                    <li className="nav-item submenu dropdown">
                                        ...
                                        <ul className="dropdown-menu">
                                            ...
                                            <li className="nav-item"><NavLink className="nav-link" to="/blogdetails" >Blog Details</NavLink></li>
                                        </ul>
                                    </li>
                                    <li className="nav-item submenu dropdown">
                                        ...
                                        <ul className="dropdown-menu">
                                            ...
                                            <li className="nav-item"><NavLink className="nav-link" to="/elements">Elements</NavLink></li>
                                        </ul>
                                    </li>
