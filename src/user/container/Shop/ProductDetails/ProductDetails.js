                            ...
                            <div className="col-lg-6">
                                <div className="s_Product_carousel">
                                    <div className="single-prd-item">
                                        <img className="img-fluid" style={{ width: '100%', maxHeight: '500px' }} src={`../` + shoeDetail?.image} />                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-5 offset-lg-1">
                                <div className="s_product_text">
                                    <h3>{shoeDetail?.name}</h3>
                                    <h2>${shoeDetail?.orgPrice}.00</h2>
                                    <ul className="list">
                                    ...
                                    <div className="product_count">
                                        ...
                                        <button onClick={() => { }} className="increase items-count" type="button"><i className="lnr lnr-chevron-up" /></button>
                                        <button onClick={() => { }} className="reduced items-count" type="button"><i className="lnr lnr-chevron-down" /></button>
                                    </div>
                                    <div className="card_area d-flex align-items-center">
                                        <a className="primary-btn" href="#">Add to Cart</a>
                                        <a className="icon_btn" href="#"><i className="lnr lnr-diamond" /></a>
                                        <a className="icon_btn" href="#"><i className="lnr lnr-heart" /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
